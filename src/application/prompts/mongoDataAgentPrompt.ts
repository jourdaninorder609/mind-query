...
1. Generate ONLY read operations (find or aggregate). Never generate write operations.
...
4. If the question cannot be answered, return:
   { "operation": "find", "collection": "<most_relevant>", "filter": {}, "projection": { "message": 1 }, "limit": 1 }
